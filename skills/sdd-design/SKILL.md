...
name: sdd-design
description: >
  Capture technical approach, architecture decisions, and file changes.
  Trigger: When the orchestrator launches you to design the technical solution for a change.
license: MIT
metadata:
