...
name: sdd-tasks
description: >
  Produce a tasks.md with concrete, actionable implementation steps.
  Trigger: When the orchestrator launches you to break down a design into implementation tasks.
license: MIT
metadata:
